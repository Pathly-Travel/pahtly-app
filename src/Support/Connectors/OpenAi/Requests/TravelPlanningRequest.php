...
use Src\Domain\TravelPlanning\Data\TravelPlanningRequestResponse;

class TravelPlanningRequest extends Request implements HasBody
{
    use HasJsonBody;
    ...
    public function createDtoFromResponse(Response $response): TravelPlanningRequestResponse
    {
        $data = $response->json();
        ...
        return new TravelPlanningRequestResponse(
